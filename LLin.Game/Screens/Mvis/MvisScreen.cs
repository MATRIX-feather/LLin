...
using LLin.Game.Screens.Mvis.SideBar;
using LLin.Game.Screens.Mvis.SideBar.Settings;
using LLin.Game.Screens.Mvis.SideBar.Tabs;
using LLin.Game.Screens.Mvis.SongSelect;
using M.DBus.Tray;
...
using osuTK.Input;
using Sidebar = LLin.Game.Screens.Mvis.SideBar.Sidebar;

namespace LLin.Game.Screens.Mvis
{
    //todo: 重写界面?
