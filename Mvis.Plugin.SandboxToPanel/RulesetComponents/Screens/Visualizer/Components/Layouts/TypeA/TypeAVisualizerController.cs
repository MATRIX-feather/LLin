...
using Mvis.Plugin.Sandbox.RulesetComponents.Screens.Visualizer.Components.MusicHelpers;
using Mvis.Plugin.Sandbox.RulesetComponents.Screens.Visualizer.Components.Visualizers;
using Mvis.Plugin.Sandbox.RulesetComponents.Screens.Visualizer.Components.Visualizers.Circular;
using osu.Framework.Allocation;
using osu.Framework.Bindables;
using osu.Framework.Graphics;
using osuTK;

namespace Mvis.Plugin.Sandbox.RulesetComponents.Screens.Visualizer.Components.Layouts.TypeA
{
