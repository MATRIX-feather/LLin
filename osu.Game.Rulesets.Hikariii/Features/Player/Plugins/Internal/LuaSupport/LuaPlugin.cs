...
using osu.Game.Rulesets.Hikariii.Features.Player.Plugins.Internal.LuaSupport.Graphics;
using osu.Game.Rulesets.Hikariii.Features.Player.Plugins.Internal.LuaSupport.LuaFunctions;
...
namespace osu.Game.Rulesets.Hikariii.Features.Player.Plugins.Internal.LuaSupport
{
    public partial class LuaPlugin : BindableControlledPlugin, IKeyBindingHandler<GlobalAction>
    {
        ...
        public LuaPlugin()
        {
            ...
            Flags.Add(LLinPlugin.PluginFlags.CanDisable);
