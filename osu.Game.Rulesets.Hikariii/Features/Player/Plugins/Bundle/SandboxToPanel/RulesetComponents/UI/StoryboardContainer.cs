...
namespace osu.Game.Rulesets.Hikariii.Features.Player.Plugins.Bundle.SandboxToPanel.RulesetComponents.UI
{
    public partial class StoryboardContainer : CurrentBeatmapProvider
    {
        ...
        private partial class StoryboardLayer : AudioContainer
        {
            ...
            private partial class FillStoryboard : DrawableStoryboard
            {
                ...
                public FillStoryboard(Storyboards.Storyboard storyboard)
                    : base(storyboard)
                {
                }
