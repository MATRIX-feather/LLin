...
namespace osu.Game.Rulesets.Hikariii.ppyStuffs.osu
{
    public partial class TrianglesV2Copy : Drawable
    {
        ...
        public (float, float) ExtraScaleRange { get; set; } = (1, 1); // LLin: Random scale
        ...
        public TrianglesV2Copy(int? seed = null)
        {
            if (seed != null)
        ...
        protected override void Update()
        {
            ...
            for (int i = 0; i < parts.Count; i++)
            {
                ...
                //                                                      LLin: Random scale
                float bottomPos = parts[i].Position.Y + triangle_size * parts[i].ExtraScale * ScaleAdjust * equilateral_triangle_ratio / DrawHeight;
                if (bottomPos < 0)
                    parts.RemoveAt(i);
            }
        ...
        {
            protected new TrianglesV2Copy Source => (TrianglesV2Copy)base.Source;
            ...
            public TrianglesDrawNode(TrianglesV2Copy source)
                : base(source)
            {
            }
            ...
            protected override void Draw(IRenderer renderer)
            {
                ...
                {
                    //                                                         LLin: Random scale
                    Vector2 relativeSize = Vector2.Divide(triangleSize * particle.ExtraScale, size);
        ...
        protected struct TriangleParticle
        {
            ...
            // LLin: Random scale
            /// <summary>
            /// The extra scale factor of the triangle
            /// </summary>
