...
namespace osu.Game.Rulesets.IGPlayer.Feature.Gosumemory.Web
{
    ...
    /// Class MimeTypeMap.
    ///
    /// Comes from <a href="https://github.com/samuelneff/MimeTypeMap"/>
    /// </summary>
    public static class MimeTypeMap
    {
        ...
        private static IDictionary<string, string> buildMappings()
        {
            ...
            var cache = newMapping.ToList(); // need ToList() to avoid modifying while still enumerating

            foreach (var mapping in cache)
            {
                if (!newMapping.ContainsKey(mapping.Value))
                    newMapping.Add(mapping.Value, mapping.Key);
            }
        ...
        public static bool TryGetMimeType(string str, out string mimeType)
        {
            ...
            var indexQuestionMark = str.IndexOf(question_mark, StringComparison.Ordinal);
        ...
        {
            return TryGetMimeType(str, out var result) ? result : default_mime_type;
        }
