...
namespace osu.Game.Rulesets.IGPlayer.Feature.Player.Plugins
{
    internal class PluginStore : NamespacedResourceStore<byte[]>
    {
        ...
        public bool Contains(string path)
        {
            ...
            catch (Exception e)
            {
                if (!(e is ArgumentException))
                    Logging.LogError(e, "获取文件路径时发生了错误");
        ...
        private void prepareLoad()
        {
            ...
            {
                Logging.LogError(e, $"载入文件时出现问题: {e.Message}");
            }
        }
        ...
        private void loadAssembly(Assembly assembly)
        {
            ...
            {
                Logging.LogError(e, $"载入 {assembly.FullName} 时出现了问题, 请联系你的插件提供方。");
            }
        }
        ...
        private void addMvisPlugin(Type pluginType, string? fullName)
        {
            ...
            {
                Logging.LogError(e, $"尝试添加插件{fullName}时出现了问题");
            }
        }
    }
}
