...
namespace osu.Game.Rulesets.IGPlayer.Settings.AccelUtils
{
    ...
    {
        private static OsuConfigManager? osuConfigManager;

        public static void SetOsuConfigManager(OsuConfigManager osuConfigManager)
        {
            AccelExtensionsUtil.osuConfigManager = osuConfigManager;
        }
                                            ...
                                            bool noSuggestion = false)
        {
            var dict = new Dictionary<string, object>
            {
                ...
                ["NOVIDEO"] = osuConfigManager?.Get<bool>(OsuSetting.PreferNoVideo) ?? false
            };

            if (overrides == null) return url.TryParseAccelUrl(dict, out result, out errors, noSuggestion);
                                            ...
                                            bool noSuggestion = false)
        {
            var dict = new Dictionary<string, object>
            {
                ...
                ["NOVIDEO"] = osuConfigManager?.Get<bool>(OsuSetting.PreferNoVideo) ?? true
            };
